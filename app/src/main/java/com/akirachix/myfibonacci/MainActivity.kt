...
import com.akirachix.myfibonacci.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val NumbersRecyclerViewAdapter = NumbersRecyclerViewAdapter(numbers)
        binding.rvNumbers.adapter = NumbersRecyclerViewAdapter
    }
